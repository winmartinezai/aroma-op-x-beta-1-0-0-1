...
import { PriceTable, Employee, Property, YearlyPricing, QuickLink } from './types';

export const APP_VERSION = "v1.0.6-alpha";
export const BUILD_DATE = "Build 04.2025.ProConfig";
